const dadosCampeonato = {
  intermediario: {
    ...
    grupoB: {
      ...
      jogos: [
        ...
        { jogador1: 'Mayke', jogador2: 'Nero', sets: [[0, 6], [0, 6]] },
        { jogador1: 'Mayke', jogador2: 'Jefferson', sets: [[1, 6], [1, 6]] },
        { jogador1: 'Mayke', jogador2: 'Bittencourt', sets: [[0, 6], [1, 6]] },
        { jogador1: 'Adriano', jogador2: 'Ceará', sets: [[6, 1], [6, 1]] },
        { jogador1: 'Adriano', jogador2: 'Nero', sets: [[6, 4], [6, 4]] },
        { jogador1: 'Adriano', jogador2: 'Jefferson', sets: [[3, 6], [6, 1], [7, 3]] },
        { jogador1: 'Adriano', jogador2: 'Bittencourt', sets: [[6, 0], [6, 0]] },
        { jogador1: 'Ceará', jogador2: 'Nero', sets: [[7, 5], [6, 0]] },
        { jogador1: 'Ceará', jogador2: 'Jefferson', sets: [] },
        { jogador1: 'Ceará', jogador2: 'Bittencourt', sets: [[6, 4], [5, 7], [10, 7]] },
  ...
  femininoKids: {
    grupoA: {
      ...
      jogos: [
        { jogador1: 'Melissa', jogador2: 'Matheus', sets: [[2, 6], [5, 6]] },
    ...
    grupoB: {
      ...
      jogos: [
        ...
        { jogador1: 'Adriana', jogador2: 'Leozinho', sets: [[6, 2], [4, 6], [10, 4]] },
        { jogador1: 'Adriana', jogador2: 'Luis', sets: [[6, 3], [6, 4]] },
        { jogador1: 'Camila', jogador2: 'Leozinho', sets: [[6, 1], [6, 2]] },
        { jogador1: 'Camila', jogador2: 'Luis', sets: [] },
        { jogador1: 'Leozinho', jogador2: 'Luis', sets: [[2, 6], [6, 2], [6, 10]] },
      ],
    },
  },
  avancado: {
    ...
    jogos: [
      ...
      { jogador1: 'Renato', jogador2: 'Jorge', sets: [[2, 6], [6, 3], [5, 10]] },
      { jogador1: 'Renato', jogador2: 'Leoni', sets: [[6, 2], [6, 1]] },
      { jogador1: 'Jorge', jogador2: 'Leoni', sets: [[6, 7], [6, 3], [10, 4]] },
    ],
  },
};
